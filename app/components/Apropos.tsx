  ...
  const story = [
    {
      label: '01',
      heading: 'Le déclic',
      text: "Je ne viens pas à l’origine du monde de l’informatique. Après un parcours dans une autre filière, j’ai découvert le développement web par curiosité — et cette curiosité s’est transformée en véritable passion. J’ai suivi une formation et obtenu un diplôme de développeur full-stack, tout en continuant à me former en autodidacte. Aujourd’hui, je crée des sites avec React et Next.js avec une idée simple : concevoir des sites qui ne sont pas seulement esthétiques, mais qui génèrent de vrais résultats pour leurs propriétaires.",
    ...
    },
    {
      label: '02',
      heading: "L'enquête",
      text: "Avant de lancer AtelierCode, j’ai voulu comprendre le marché. Pour voir les choses du point de vue d’un client, j’ai fait une petite expérience : j’ai fait semblant d’être plombier et j’ai contacté trois agences web à Nîmes pour demander un devis pour un site vitrine. Les réponses étaient similaires : entre 1 200 € et 2 500 €, avec 4 à 6 semaines de délai, souvent pour des sites WordPress assez standards. C’est là que j’ai compris qu’il y avait une opportunité : beaucoup de petites entreprises ont besoin d’un site professionnel, mais les solutions proposées sont souvent trop chères ou trop génériques. L’idée d’AtelierCode est née de ce constat : créer des sites modernes, rapides et efficaces, à un prix plus accessible.",
    ...
    },
    {
      label: '03',
      heading: 'La mission',
      text: "AtelierCode est né de cette conviction : les petites entreprises méritent un site professionnel, performant et réellement adapté à leur activité — sans payer le prix d’une grande agence. Je développe avec React et Next.js, ce qui me permet de créer des sites rapides, modernes et optimisés pour le référencement sur Google. Et surtout : vous travaillez directement avec le développeur — sans intermédiaire, avec un vrai échange et une transparence totale.",
