// app/components/Tarifs.tsx - ФІНАЛЬНИЙ ФІКС
'use client';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {plans.map((plan, index) => (
            ...
            >
              ...
              {/* Основна картка - БЕЗ backdrop-blur-sm */}
              <div className={`relative h-full bg-gradient-to-br from-gray-900/50 to-black/50 p-8 rounded-2xl border ${plan.accent} transition-all duration-300 group-hover:border-gray-600 overflow-hidden ${plan.popular ? 'lg:mt-4' : ''}`}>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl opacity-0 group-hover:opacity-30 blur-xl transition-opacity duration-500"></div>
              <div className="relative h-full bg-gradient-to-br from-gray-900/50 to-black/50 p-6 rounded-2xl border border-gray-800 transition-all duration-300 group-hover:border-gray-600 overflow-hidden">
