// app/components/Tarifs.tsx - БЕЗ Framer Motion
'use client';
...
export default function Tarifs() {
  ...
  return (
    <section className="relative py-20 bg-black">
      {/* Спрощений фон без blur */}
      <div className="absolute inset-0 bg-black"></div>
      
      <div className="container mx-auto px-4 relative">
        {/* Заголовок без анімацій */}
        ...
        <div className="flex flex-col md:flex-row gap-6 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            ...
            >
              ...
              {/* Картка */}
              <div className={`p-6 rounded-xl border ${plan.accent} bg-gray-900 h-full`}>
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row gap-6 mb-12">
            {[
              ...
              <div
                key={idx}
                className="flex-1 p-6 rounded-xl border border-gray-800 bg-gray-900"
              >
          ...
          {/* CTA */}
          <div className="text-center p-8 rounded-xl border border-gray-800 bg-gray-900">
