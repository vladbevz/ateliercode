          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-zinc-100">Introduction</h2>
              </div>
              <div className="space-y-4 pl-11">
                ...
                <div className="p-4 rounded-xl bg-zinc-800 border border-zinc-700">
                  <p className="text-sm font-semibold text-zinc-300 mb-3">Conformité légale :</p>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-zinc-100">Données personnelles collectées</h2>
              </div>
              <div className="space-y-5 pl-11">
                <div>
                  <p className="text-sm font-medium text-zinc-500 mb-3">Données fournies volontairement :</p>
                  <ul className="space-y-2">
                    {[
                ...
                <div>
                  <p className="text-sm font-medium text-zinc-500 mb-3">Données collectées automatiquement :</p>
                  <ul className="space-y-2">
                    {[
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-zinc-100">Finalités du traitement</h2>
              </div>
              <div className="space-y-4 pl-11">
                <p className="text-sm text-zinc-400">Nous utilisons vos données pour :</p>
                <ul className="space-y-2">
                  {[
                ...
                <div className="p-4 rounded-xl bg-zinc-800 border border-zinc-700 text-sm text-zinc-400">
                  <span className="font-medium text-zinc-300">Base légale : </span>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-zinc-100">Durée de conservation</h2>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-zinc-100">Vos droits</h2>
              </div>
              <div className="pl-11">
                <p className="text-sm text-zinc-400 mb-5">Conformément au RGPD, vous disposez des droits suivants :</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={i} className="p-4 rounded-xl bg-zinc-800 border border-zinc-700 hover:border-gray-300 transition-colors">
                      <p className="text-sm font-semibold text-zinc-100 mb-1">{right.title}</p>
                      <p className="text-xs text-zinc-400">{right.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-4 pl-11">
                <div className="p-5 rounded-xl bg-zinc-800 border border-zinc-700">
                  <p className="text-sm font-medium text-zinc-300 mb-3">Délégué à la protection des données (DPO) :</p>
                  <div className="space-y-3 text-sm">
                    <div>
                      <span className="text-zinc-500">Nom : </span>
                      <span className="text-zinc-200 font-medium">Bevz Vladyslav</span>
                    </div>
                    <div>
                      <span className="text-zinc-500">Email : </span>
                      <a href="mailto:contact@ateliercode.fr" className="text-amber-400 font-medium hover:underline">
                ...
                <div className="p-5 rounded-xl bg-zinc-800 border border-zinc-700">
                  <p className="text-sm font-medium text-zinc-300 mb-2">Autorité de contrôle :</p>
                  <p className="text-sm text-zinc-400 mb-2">Vous avez le droit de déposer une réclamation auprès de la CNIL :</p>
                  <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer"
                    className="text-sm text-zinc-300 hover:text-zinc-100 hover:underline transition-colors font-medium">
                    https://www.cnil.fr
                  </a>
                </div>
              </div>
