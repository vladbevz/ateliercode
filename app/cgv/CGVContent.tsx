      ...
      <div className="max-w-4xl mx-auto px-4 py-16 md:py-24 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8 p-6 rounded-2xl bg-amber-950/20 border border-amber-800/30"
          >
          ...
          <div className="space-y-6">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-zinc-100">Objet</h2>
              </div>
              <div className="space-y-4 pl-11">
                ...
                <div className="p-4 rounded-xl bg-zinc-800 border border-zinc-700">
                  <p className="text-sm font-semibold text-zinc-300 mb-3">Champ d'application :</p>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-8 h-8 rounded-xl bg-zinc-800 text-amber-400 flex items-center justify-center shrink-0">
                  <Shield className="w-4 h-4" />
                </div>
                <h2 className="text-xl font-bold text-zinc-100">Identification du vendeur</h2>
              </div>
              <div className="space-y-3 pl-11">
                {[
                  ...
                  <div key={i} className="flex flex-col sm:flex-row sm:gap-3 text-sm">
                    <span className="font-medium text-zinc-500 sm:w-32 shrink-0">{item.label} :</span>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-zinc-100">Prix et paiement</h2>
              </div>
              <div className="space-y-6 pl-11">
                <div>
                  <h4 className="text-sm font-semibold text-zinc-300 mb-3">5.1. Prix</h4>
                  <div className="p-4 rounded-xl bg-zinc-800 border border-zinc-700">
                    <p className="text-sm text-zinc-400">Les prix sont indiqués en euros hors taxes (HT).</p>
                    <div className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-amber-950/20 border border-amber-800/30">
                      <span className="text-sm font-semibold text-amber-300">TVA non applicable</span>
                      <span className="text-xs text-amber-500">(art. 293 B du CGI)</span>
                    </div>
                  </div>
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-zinc-300 mb-3">5.2. Modalités de paiement</h4>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={i} className="p-4 rounded-xl bg-zinc-800 border border-zinc-700 text-center hover:border-gray-300 transition-colors">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-zinc-100">Délais et livraison</h2>
              </div>
              <div className="space-y-5 pl-11">
                <div>
                  <h4 className="text-sm font-semibold text-zinc-300 mb-3">6.1. Délais de réalisation</h4>
                  <p className="text-sm text-zinc-400 mb-3">Les délais de réalisation sont indiqués à titre indicatif sur le devis.</p>
                  <div className="p-4 rounded-xl bg-zinc-800 border border-zinc-700">
                    <p className="text-sm font-medium text-zinc-300 mb-2">Modifications possibles en cas de :</p>
                ...
                <div>
                  <h4 className="text-sm font-semibold text-zinc-300 mb-3">6.2. Livraison</h4>
                  <div className="p-4 rounded-xl bg-zinc-800 border border-zinc-700">
                    <p className="text-sm font-medium text-zinc-300 mb-2">Le service est considéré comme livré lorsque :</p>
                    <ul className="space-y-2">
                      {[
                        ...
                        <li key={i} className="flex items-start gap-2 text-sm text-zinc-400">
                          <div className="w-4 h-4 rounded border border-gray-300 flex items-center justify-center shrink-0 mt-0.5">
            ...
            <motion.section
              ...
              className="bg-amber-950/20 rounded-2xl p-8 border border-amber-800/30"
            >
              <div className="flex items-center gap-3 mb-6">
                <div className="w-8 h-8 rounded-xl bg-amber-100 border border-amber-300 flex items-center justify-center shrink-0">
                  <AlertTriangle className="w-4 h-4 text-amber-600" />
                </div>
                <h2 className="text-xl font-bold text-amber-300">Droit de rétractation</h2>
              </div>
              <div className="space-y-3 pl-11 text-sm text-amber-400">
                <p>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-zinc-100">Garanties</h2>
              </div>
              <div className="space-y-3 pl-11">
                {[
                  {
                  ...
                  <div key={i} className="p-4 rounded-xl bg-zinc-800 border border-zinc-700">
            ...
            >
              ...
              <div className="pl-11">
                <div className="p-5 rounded-xl bg-zinc-800 border border-zinc-700">
                  <p className="text-sm font-medium text-zinc-300 mb-4">Pour toute question relative aux CGV :</p>
                  <div className="space-y-3 text-sm">
                    {[
                      ...
                      <div key={i}>
                        ...
                        {item.link
                          ? <a href={item.link} className="text-amber-400 font-medium hover:underline">{item.value}</a>
